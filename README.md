...
Este é um projeto inicial construído com Python e a biblioteca Pygame. O ambiente foi configurado para rodar de forma isolada usando um ambiente virtual (`venv`).

## 🛠️ Pré-requisitos

Para rodar este projeto, você precisará do **Python 3** instalado.

Para verificar a versão do Python no seu sistema, use:
